...
- - A token is used for Authentication and data transfer based on the clients permission.

2. What steps can you take in your web apps to keep your data secure?

- Use a token, create a private route, dont put all your data in local storage.

3. Describe how web servers work.

- stores the code for all the different websites to be shared across the world whenever you request it.

4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

-Axios put,delete, get and post
